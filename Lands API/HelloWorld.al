        ...
        area(Processing)
        {
            action(ActionName)
            {
                ...
                begin
                    ...
                    // if HttpClient.Get('https://api.businesscentral.dynamics.com/v2.0/9b540f11-2b5c-4c74-bb40-a4d22950e763/PROD/ODataV4/Companies(E5554158-808F-ED11-9989-6045BD694026)/Chart_of_Accounts', HttpResponseMessage) then begin
                    if HttpClient.Get('https://api.businesscentral.dynamics.com/v2.0/9b540f11-2b5c-4c74-bb40-a4d22950e763/PROD/ODataV4/' + comp, HttpResponseMessage) then begin
                        // Read response body
            ...
            action(POST)
            {
                ...
                begin
                    ...
                    HttpRequestMessage.SetRequestUri('https://api.businesscentral.dynamics.com/v2.0/9b540f11-2b5c-4c74-bb40-a4d22950e763/PROD/ODataV4/MStest_CreateSalesOrderMarketerForm?company=ALINMA%20FOR%20REAL%20ESTATE');
                    HttpRequestMessage.GetHeaders(ContentHeaders);
                    HttpRequestMessage.Content(Content);
                    HttpClient.Send(HttpRequestMessage, HttpResponseMessage);
                    //    HttpClient.Post('https://api.businesscentral.dynamics.com/v2.0/9b540f11-2b5c-4c74-bb40-a4d22950e763/PROD/ODataV4/MStest_CreateSalesOrderMarketerForm?company=ALINMA%20FOR%20REAL%20ESTATE', Content, HttpResponseMessage);
                    HttpResponseMessage.Content.ReadAs(ResponseBody);
                    Message(ResponseBody);
                end;
            }
